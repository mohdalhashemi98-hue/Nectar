...
const JobConfigurationScreen: React.FC = () => {
  ...
  return <Original requestDetails={requestDetails} setRequestDetails={setRequestDetails} selectedCategory={selectedCategory} selectedSubService={selectedSubService} onBack={goBack} onNavigate={navigateTo} onSubmit={resetRequestForm} />;
};
