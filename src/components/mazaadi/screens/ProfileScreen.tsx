      ...
      <div className="bg-foreground text-background p-6 pb-20 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <button className="w-10 h-10 rounded-full bg-background/10 flex items-center justify-center hover:bg-background/20 transition-all">
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-background/20 rounded-2xl flex items-center justify-center text-2xl font-bold">
                {userProfile.avatar}
              </div>
              <div className="flex-1">
                <h3 className="text-xl font-bold">{userProfile.name}</h3>
                <p className="opacity-60 text-sm">{userProfile.phone}</p>
              </div>
              <div className="flex items-center gap-1.5 bg-background/10 px-3 py-1.5 rounded-full">
