  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'We accept credit/debit cards, Apple Pay, and Nectar Wallet. Cash payments are also available for select services.'
      },
      {
    ...
    questions: [
      {
        ...
        a: 'Yes, all professionals on Nectar go through a verification process that includes ID verification, license checks (where applicable), and background screening.'
      },
      {
